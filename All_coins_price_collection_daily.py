...
def data_collection(token_symbol, interval='1d',start="2017-01-01",end='2026-02-19',freq='30D'):
    ...
    price_data.to_csv(f'/local/scratch/yuzhang_utxo/token_price/{token_symbol}_daily_price.csv')
